      ...
      modal.innerHTML = `
        <div class="lang-modal-dialog notranslate" translate="no">
          <div class="lang-modal-header notranslate" translate="no">
            ...
            <button class="lang-modal-close-btn notranslate" id="lang-modal-close" translate="no" aria-label="Close language selector" title="Close language selector"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></button>
          </div>
